...
<body>
            ...
            <div class="content">
                ...
                <div class="price">
                    ...
                    <div class="up">
                        ...
                        <p><i class="fa-solid fa-fire"></i> 17 Items dibeli dalam 1 hari terakhir</p>
                    </div>
                    <div class="item">
                    <?php 
                        $product = mysqli_query($conn, "SELECT * FROM produk_form WHERE game = 'MobileLegend';");
                        $no = 0;
                ...
                <div class="gateway">
                    ...
                    <a type="submit" href="mlbb.php#blur" class="gateway-order" onclick="toggle()">
                        <p>Beli Sekarang </p>
    ...
    <div id="popup" class="popup">
        <img src="../imgpage/done.png">
                ...
                <div class="user-details">
                    ...
                    <div class="transfer">
                        ...
                        <div class="whatsapp">
                            ...
                            <p>Kirim Bukti Transfer ke <a href="https://api.whatsapp.com/send/?phone=6285730470740&text&type=phone_number&app_absent=0" target="_blank">+6285730470740</a></p>
                        </div>
                    </div>
            </form>
            <div class="shorcut">
            ...
            <a class="next" href="mlbb.php" onclick="Closetoogle()">
