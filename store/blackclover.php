...
<body>
    ...
    <div class="produk" id="blur">
        <div class="row">
            <div class="profil">
                <img src="../imgpage/blackclover3.jpg">
            ...
            <div class="content">
                <div class="judul">
                <h1>Black Clover Mobile</h1>
                <p>Garena International II</p>
                ...
                <div class="price">
                    ...
                    <div class="up">
                        <p><i class="fa-solid fa-fire"></i> 4 Items dibeli dalam 1 hari terakhir</p>
                    </div>

                    
                    <div class="item">
                    <?php 
                        $product = mysqli_query($conn, "SELECT *FROM produk_form WHERE game = 'blackclover';");
                        while($result = mysqli_fetch_assoc($product)){
                    ?>
                        <div class="price-item" id="price<?php echo $result['id']; ?>" onclick="getVal<?php echo $result['id']; ?>();" value="<?php echo $result['price']; ?>" name="<?php echo $result['name']; ?>">
                ...
                <div class="gateway">
                    ...
                    <a type="submit" href="blackclover.php#blur" class="gateway-order" onclick="toggle()">
                        <p>Beli Sekarang </p>
    ...
    <div id="popup" class="popup">
        <img src="../imgpage/done.png">
            ...
            <a class="next" href="blackclover.php" onclick="Closetoogle()">
