...
<body>
    ...
    <div class="produk" id="blur">
        <div class="row">
            <div class="profil">
                <img src="../imgpage/valorant3.jpeg">
            ...
            <div class="content">
                ...
                <div class="ads">
                    <p><i class="fa-solid fa-crown"></i> Product PC Terbaik</p>
                </div>
                </div>
                <div class="akun">
                ...
                <div class="price">
                    ...
                    <div class="up">
                        <p><i class="fa-solid fa-fire"></i> 15 Items dibeli dalam 1 hari terakhir</p>
                    </div>
                    <div class="item">
                    <?php 
                        $product = mysqli_query($conn, "SELECT * FROM produk_form WHERE game = 'Valorant';");
                        $no = 0;
                ...
                <div class="gateway">
                    ...
                    <a type="submit" href="valorant.php#blur" class="gateway-order" onclick="toggle()">
                        <p>Beli Sekarang </p>
    ...
    <div id="popup" class="popup">
        <img src="../imgpage/done.png">
            ...
            <a class="next" href="valorant.php" onclick="Closetoogle()">
