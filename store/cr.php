...
<body>
    ...
    <div class="produk" id="blur">
        <div class="row">
            <div class="profil">
                <img src="../imgpage/clashroyale3.webp">
            ...
            <div class="content">
                ...
                <div class="price">
                    ...
                    <div class="item">
                    <?php 
                        $product = mysqli_query($conn, "SELECT * FROM produk_form WHERE game = 'ClashRoyale';");
                        $no = 0;
                ...
                <div class="gateway">
                    ...
                    <a type="submit" href="cr.php#blur" class="gateway-order" onclick="toggle()">
                        <p>Beli Sekarang </p>
    ...
    <div id="popup" class="popup">
        <img src="../imgpage/done.png">
            ...
            <a class="next" href="cr.php" onclick="Closetoogle()">
