...
<body>
    ...
    <div class="produk" id="blur">
        <div class="row">
            <div class="profil">
                <img src="../imgpage/gensinicon2.webp">
            ...
            <div class="content">
                ...
                <div class="price">
                    ...
                    <div class="up">
                        <p><i class="fa-solid fa-fire"></i> 21 Items dibeli dalam 1 hari terakhir</p>
                    </div>
                    <div class="item">
                    <?php 
                        $product = mysqli_query($conn, "SELECT * FROM produk_form WHERE game = 'GenshinImpact';");
                        $no = 0;
                ...
                <div class="gateway">
                    ...
                    <a type="submit" href="genshinimpact.php#blur" class="gateway-order" onclick="toggle()">
                        <p>Beli Sekarang </p>
    ...
    <div id="popup" class="popup">
        <img src="../imgpage/done.png">
            ...
            <a class="next" href="genshinimpact.php" onclick="Closetoogle()">
