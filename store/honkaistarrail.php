...
<body>
        ...
        <div class="row">
            ...
            <div class="content">
                ...
                <div class="price">
                    ...
                    <div class="item">
                    <?php 
                        $product = mysqli_query($conn, "SELECT * FROM produk_form WHERE game = 'Honkai:StarRail';");
                        $no = 0;
                ...
                <div class="gateway">
                    ...
                    <a type="submit" href="honkaistarrail.php#blur" class="gateway-order" onclick="toggle()">
                        <p>Beli Sekarang </p>
    ...
    <div id="popup" class="popup">
        <img src="../imgpage/done.png">
            ...
            <a class="next" href="honkaistarrail.php" onclick="Closetoogle()">
